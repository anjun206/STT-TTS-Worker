...
def full_pipeline(job_details: dict):
    ...
    target_lang = normalize_lang_code(job_details.get("target_lang")) or "en"
    ...
    try:
        ...
        # speaker_refs.json을 S3에 업로드 (ASR 단계에서 생성됨)
        from services.speaker import upload_speaker_refs
