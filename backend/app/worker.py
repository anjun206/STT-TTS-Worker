...
class QueueWorker:
    def __init__(self) -> None:
        ...
        self.callback_localhost_host = os.getenv("JOB_CALLBACK_LOCALHOST_HOST", "host.docker.internal")
    ...
    def _normalize_callback_url(self, callback_url: str) -> str:
        ...
        if parsed.hostname in {"localhost", "127.0.0.1"} and self.callback_localhost_host:
